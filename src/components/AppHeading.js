...
class AppHeading extends Component{
    ...
    render(){
      return(
        ...
        <div className='mt-3'>
            <p class='lead'>
                See live statistics of the ongoing COVID-19 pandemic that includes the current count of cases, deaths, recovered and active infections in all affected countries. You can search any country to see its figures from the search bar and the table for more insights.
            </p>
        </div>
