        ...
        <div className='container-lg shadow-sm pt-1 pl-3 pr-3 pb-1 mb-4 bg-white rounded'>
            <div className='mt-3'>
                <p style={{fontSize:20, fontWeight:'300'}} className="mb-2">
                    See live statistics of the ongoing COVID-19 pandemic that include the current count of cases, deaths, recovered and active infections in all affected countries. You can search any country from the search bar to its see figures and charts and the table below it for more insights.
                </p>
            </div>
