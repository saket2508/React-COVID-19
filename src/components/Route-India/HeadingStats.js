...
function MainHeading(){
    const mainheading=(
        <div className='container-lg shadow-sm p-3 mb-4 bg-white rounded mt-2'>
                ...
                <h5 className='text-center' style={{fontWeight:'600'}}>CASES IN INDIA</h5>
    ...
    const summary=(
        ...
        <div class="card" style={{backgroundColor:'#f5f5f5'}}>
            <div class="card-body">
                ...
                <p className='h4 text-secondary text-center' style={{fontWeight:'600'}}>{props.data.confirmed}</p> 
        ...
        <div class="card" style={{backgroundColor:'#ffebee'}}>
            <div class="card-body"> 
                ...
                <p className='h4 text-danger text-center' style={{fontWeight:'600'}}>{props.data.deaths}</p>
        ...
        <div class="card" style={{backgroundColor:'#e8f5e9'}}>               
            ...
            <p class="h6 card-title text-center" style={{fontWeight:'600',color:'#43a047'}}>RECOVERED</p>
                <p className='h4 text-center' style={{fontWeight:'600',color:'#43a047'}}>{props.data.recovered}</p>  
        ...
        <div class="card" style={{backgroundColor:'#e1f5fe'}}>               
            ...
            <p class="h6 card-title text-center" style={{fontWeight:'600',color:'#0288d1'}}>ACTIVE</p>
                <p className='h4 text-center' style={{fontWeight:'600',color:'#0288d1'}}>{props.data.active}</p>               
            </div>
        </div>
        </div>
        </div>
